...
fun GamesContentLayout(
    ...
    rows: List<GamesRow>,
    moviesMap: Map<MovieCategory, GamesState<Movie>>,
    seriesMap: Map<SerieCategory, GamesState<Serie>>,
            ...
            when (row) {
                ...
                is GamesRow.SeriesRow -> {
                    ...
                    when (gamesState) {
                        ...
                        is GamesState.Success -> SeriesLazyRow(row.category.title, seriesList = gamesState.items, onSerieClick = onSeriesClick)
