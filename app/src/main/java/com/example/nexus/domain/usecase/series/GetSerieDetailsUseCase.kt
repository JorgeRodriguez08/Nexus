...
data class GetSerieDetailsUseCase(private val repository: SeriesRepository) {
    operator fun invoke(serieId: Int): Flow<Resource<SerieDetails>> =
        repository.getSerieDetails(serieId)
}
